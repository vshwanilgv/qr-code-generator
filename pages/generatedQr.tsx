            ...
            <div className='w-full h-12 bg-purple1 flex-auto rounded-2xl px-5'>
                ...
                <div className='flex justify-start'>
                    ...
                    <div className='flex justify-end absolute top-0 right-0'>
                        <div className='px-3'>
                            <button className='bg-purple2 text-white font-bold text-xl rounded-2xl w-1/5 p-1 mt-1'>Login</button>
                        </div>
                        <div className='px-3'>
                            <button className='bg-purple2 text-white font-bold text-xl rounded-2xl w-1/5 p-1 mt-1'>SignUp</button>
                        </div>
                    </div>
                </div>
